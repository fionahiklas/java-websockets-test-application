    ...
    public ScheduledFuture<?> registerWebSocketSessionWithPinger(WebSocketSession webSocketSession)
        ...
        Runnable runner = new Runnable() {
            ...
            public void run() {
                ...
                payloadBuffer.putLong(currentTimestamp);
                payloadBuffer.flip(); // Reset the position of the buffer so that it can be read

                WebSocketMessage<ByteBuffer> pingMessage = new PingMessage(payloadBuffer);
